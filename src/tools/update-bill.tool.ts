...
const toolSchema = z.object({
  bill: z.object({
    Id: z.string(),
    SyncToken: z.string().describe("Required by QBO optimistic locking — get from get-bill first"),
    Line: z.array(z.object({
      Id: z.string().optional().describe("Line ID from existing bill — required to update in place"),
      Amount: z.number(),
      DetailType: z.string(),
